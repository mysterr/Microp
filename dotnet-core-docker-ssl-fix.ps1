...
dotnet user-secrets set "Kestrel:Certificates:Default:Password" $Env:Guid --project $project
...
if($docker){
    ...
    dotnet user-secrets set "Kestrel:Certificates:Default:Path" $dockerPath --project $project
}
