...
namespace Web.Infrastructure
{
    public class ProductRepository : IRepository<Product>
    {
        ...
        public async Task Create(Product item)
        {
            ...
            using (var qClient = _clientFactory.CreateClient("ProductsClient"))
            {
                qClient.BaseAddress = new Uri(_QServiceBaseUrl);
                try
                {
        ...
        {
            using (var dClient = _clientFactory.CreateClient("ProductsClient"))
            {
                dClient.BaseAddress = new Uri(_DServiceBaseUrl);
                try
                {
